...
const experiences: ExperienceEntry[] = [
  {
    ...
    badgeColor: 'green',
    bullets: [
      'Oversee daily store operations, staff scheduling, and performance management across multiple shifts',
      'Deliver exceptional customer service, troubleshoot client concerns, and maintain 95%+ satisfaction ratings',
      'Manage inventory control, stock replenishment, and supplier relationships to optimize product availability',
      'Process cash transactions, reconcile daily reports, and maintain accurate financial records',
      'Train, mentor, and develop team members across various departments to enhance operational efficiency',
      'Drive business growth initiatives through cost optimization, process improvements, and customer retention strategies',
    ],
  },
  {
    id: 2,
    ...
    badge: '3 Internal Promotions',
    badgeColor: 'gold',
    bullets: [
      'Performed diverse operational roles including cashier, food preparation, and customer service representative',
      'Maintained strict quality standards in food preparation, ensuring freshness and presentation excellence',
      'Efficiently managed high-volume customer orders during peak service times with accuracy and speed',
      'Adhered to comprehensive hygiene and health compliance protocols for safe food handling',
      'Earned three internal promotions in 16 months, reflecting exceptional work ethic and professional development',
    ],
  },
]

const progressionSteps = [
  { label: 'Entry Level', date: '2023', icon: Star },
  { label: 'Cashier', date: '2023', icon: Briefcase },
  { label: 'Team Lead', date: '2024', icon: TrendingUp },
...
const keyAchievements = [
  {
    ...
    value: '3',
    suffix: '',
    label: 'Promotions in 16 Months',
    description: 'Rapid career advancement',
